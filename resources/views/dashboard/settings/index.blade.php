                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex items-center justify-between py-4">
                        <div class="flex flex-col flex-grow">
                            ...
                            <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send an email reminding
                                me to rate an item a week after purchase</div>
                        </div>
                    ...
                    <div class="flex items-center justify-between py-4">
                        <div class="flex flex-col flex-grow">
                            ...
                            <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send user and product
                                notifications for you</div>
                        </div>
                    ...
                    <div class="flex items-center justify-between py-4">
                        <div class="flex flex-col flex-grow">
                            ...
                            <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send me an email when
                                someone comments on one of my items</div>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-4">
                        <div class="flex flex-col flex-grow">
                            ...
                            <div class="text-base font-normal text-gray-500 dark:text-gray-400">Send me an email when
                                someone leaves a review with their rating</div>
                        </div>
